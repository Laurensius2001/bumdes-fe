...
import { useBreakpoints } from '@/lib/providers/BreakpointsProvider';
...
export default function CustomPagination({ ActionsComponent, ...props }: any) {
  return <GridPagination slots={{ actions: Pagination }} {...props} />;
}
